...
public final class MathUtils
{
    ...
    public static final byte NB = (byte) (-1);

    public static final short NS = (short) (-1);

    public static final byte PB = (byte) 1;

    public static final short PS = (short) 1;

    public static final byte ZB = (byte) 0;

    public static final short ZS = (short) 0;
    ...
    public static  long addAndCheck( long a, long b, java.lang.String msg )
    {
        long ret;
        if (a > b) {
    ...
    public static  double nextAfter( double d, double direction )
    {
        ...
        if (d * (direction - d) >= 0) {
            ...
            if (mantissa == 0L) {
                return Double.longBitsToDouble( exponent - 0x0010000000000000L | 0x000fffffffffffffL );
            } else {
                return Double.longBitsToDouble( sign | exponent | mantissa - 1 );
            }
        }
